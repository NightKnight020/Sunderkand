    ...
    <section className="py-20 px-6 bg-white">
      <div className="max-w-4xl mx-auto text-center">
          ...
          {[
            ...
            >
              <div className="text-center">
                ...
                <p className="text-xs text-saffron-700/70 leading-tight">
                  {title}
                </p>
              </div>
            </div>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-gradient-to-r from-saffron-500 to-saffron-600 text-white font-semibold px-8 py-4 rounded-full hover:from-saffron-600 hover:to-saffron-700 transition-all shadow-lg hover:shadow-xl"
        >
          <svg
            className="w-5 h-5"
            fill="currentColor"
